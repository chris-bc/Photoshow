...
public class NewMessageNotification {
     ...
     * @see #cancel(Context)
     */
    public static void notify(final Context context, Bitmap picture) {
        ...
        Intent removeIntent = new Intent( "action_remove_timer", null, context, TimerService.class );
        PendingIntent pendingRemoveIntent = PendingIntent.getService( context, 0, removeIntent, PendingIntent.FLAG_CANCEL_CURRENT );
...
*/
                ...
                .addAction(
                        ...
                        res.getString(R.string.action_browse),
                        null)
